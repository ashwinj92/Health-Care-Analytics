...
# -------------------------    MAIN   ----------------------------------------- 
#
total_time = 60*1 # in seconds , we can change for specific time
start = time.time()
#-------------------------------------------------------------
...
while True:
    ...
    #except (time.time() - start)>total_time:
...
# This script is for saving data Script_1
